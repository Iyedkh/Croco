                            ...
                            <ul className="pagination justify-content-center">
                                {pageNumbers.map((pageNumber) => (
                                    <li key={pageNumber} className={`page-item ${currentPage === pageNumber ? 'active' : ''}`}>
                                        <Link onClick={() => changePage(pageNumber)} to={`/Stores/${storeId}/Team?page=${pageNumber}`} className="page-link">{pageNumber}</Link>
                                    </li>
                                ))}
                            </ul>
                        </nav>
...
export default CrocoTeamProducts;