...
<div style={{ marginLeft: '50px'}}>
    <h3 style={{ fontFamily: 'Impact', fontSize: '40px', color: 'white',letterSpacing: '1.5px'}}>{productData.title}</h3>
    <div style={{ marginBottom: '30px' }}></div>
    <p style={{ fontFamily: 'Impact', fontSize: '23px', color: 'black' }}>{productData.detail}</p>
    <div style={{ marginBottom: '60px' }}></div>
    <h3 style={{ fontFamily: 'Impact', fontSize: '33px', color: 'white', display: 'inline-block',letterSpacing: '1.5px' }}>Prix: {productData.price}DT</h3>
        ...
        {relatedProducts.reduce((acc, product, index) => {
            ...
            acc[acc.length - 1].push(
                <div className="col" key={index} style={{ display: 'flex', justifyContent: 'center', padding: '0' }}>
                    <div style={{ width: '250px', height: '350px', overflow: 'hidden', margin: '0px' }}> {/* Adjusted size */}
