...
{% block breadcrumbs %}
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">{% trans 'Home page' %}</li>
    </ol>
{% endblock %}
                                        ...
                                        <td>
                                            <div class="btn-group float-right">
                                                ...
                                                {% if model.url %}
                                                    ...
                                                    {% else %}
                                                        <a href="{{ model.url }}" class="btn btn-xs {{ jazzmin_ui.button_classes.info }} changelink">{% if model.custom %}{% trans 'Go' %}{% else %}{% trans 'View' %}{% endif %}</a>
                                                    {% endif %}
                                                {% endif %}
                                            </div>
                                        </td>
